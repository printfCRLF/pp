...
def covariance_and_pearson_correlation_coefficient(versicolor_petal_length, versicolor_petal_width):
...
def compute_covariance(versicolor_petal_length, versicolor_petal_width):
...
def computing_pearson_correlation_coefficient(versicolor_petal_length, versicolor_petal_width):
...
# comparing_percentiles_to_ECDF(versicolor_petal_length)
# box_and_whisker_plot(df)
# variance_and_standard_deviation(versicolor_petal_length)
# covariance_and_pearson_correlation_coefficient(
#     versicolor_petal_length, versicolor_petal_width)
# compute_covariance(versicolor_petal_length, versicolor_petal_width)
