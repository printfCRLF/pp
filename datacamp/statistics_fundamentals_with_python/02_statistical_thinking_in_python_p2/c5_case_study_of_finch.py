...
from util import draw_perm_reps, diff_of_means, pearson_r, ecdf, draw_bs_reps, draw_bs_pairs_linreg
...
def hypothesis_are_beaks_deeper_in_2012(mean_diff):
...
def linear_regressions():
    ...
    return bs_slope_reps_1975, bs_intercept_reps_1975, bs_slope_reps_2012, bs_intercept_reps_2012
...
def display_linear_regression_results():
    # Make scatter plot of 1975 data
    _ = plt.plot(bl_1975, bd_1975, marker='.',
...
def measuring_heritability():
    ...
    return heritability_scandens, heritability_fortis


def is_beak_depth_heritable_at_all_at_g_scandens():
...
eda_of_beak_depths()
#mean_diff = parameter_estimates_of_beak_depths()
# hypothesis_are_beaks_deeper_in_2012(mean_diff)
# The null hypothesis is that the observed difference in the means of beak depths are by chance. 
# The beak depths have not gotten deeper from year 1975 to 2012
# p value is 0.0034, it is signifcantly different. Which rejects the null hypothesis.  

# eda_of_beak_length_and_depth()
#bs_slope_reps_1975, bs_intercept_reps_1975, bs_slope_reps_2012, bs_intercept_reps_2012 = linear_regressions()
# display_linear_regression_results()
# beak_length_to_depth_ratio()
# eda_of_heritability()
# pearson_correlation_of_offspring_and_parental_data()
heritability_scandens, heritability_fortis = measuring_heritability()
is_beak_depth_heritable_at_all_at_g_scandens()
